...
public class QADocPublish extends TaskScripting {


    private static Logger log;
    public ISession ses;
    private IDialog dlg;
    public QADocPublish(ITask task){
        super(task);
        this.log=super.log;
    }
    @Override
    ...
    public IBasicAction onCommit(IDialog dialog) throws EvitaWebException {
        ...
        try {
            ...
            if(!psts.equals("DRAFT") && !psts.equals("IMPORT")){
                throw new Exception("Please select import and draft document. [" + psts + "]");
            }
            ...
            parent.setDescriptorValue(GeneralLib.Descriptors.Status, "WA4APRV");
            parent.setDescriptorValue(GeneralLib.Descriptors.RevNr, "");
            parent.commit();
